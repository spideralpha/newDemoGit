    ...
    l = a.Slider = a.Scroll.extend({
            ...
            if (b.target === c.wrapper) {
                ...
                if (m) {
                    ...
                    h = n.length; h > g; g++) n[g].classList[g === d.slideNumber ? "add": "remove"](i);
                        ...
                        else for (var p = c.wrapper.querySelectorAll(".mui-control-item"), g = 0, h = p.length; h > g; g++) p[g].classList[g === d.slideNumber ? "add": "remove"](i)
                    }
                }
                b.stopPropagation()
            }
        ...
        handleEvent: function(b) {
            ...
            case "slide":
                this._handleSlide(b);
                break;
            case a.eventName("shown", "tab") : this._handleTabShow(b)
            }
        },
...
function(a, b, c) {
    ...
    q = function() {
        ...
        a.addEventListener("webkitTransitionEnd",
        function() {
